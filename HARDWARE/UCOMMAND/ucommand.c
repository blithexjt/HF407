...
u8 CheckUartCommand()
{
	...
	if(RX_END_Success == com1_recv_end_flag)
	{
		...
		else if(strstr((char*)com1_rx_buffer,"MOTORX-S:"))
		{
			...
			MotorSetSpeed( Motor_x,  (pdBuffer[0]/(10.00)));
			return 1;
		}
		...
		else if(strstr((char*)com1_rx_buffer,"MOTORX-RUN:"))
		{
			...
			printf("MOTORX-RUN:RECEIVE:%f,%f mm/s,%f mm\r\n",Current[(u8) pdBuffer[0]],(pdBuffer[1]/(10.00)),(pdBuffer[2]/(10.00)));
			MotorRun( Motor_x,  (u8) pdBuffer[0],(pdBuffer[1]/(10.00)), (pdBuffer[2]/(10.00)));
			return MOTORX_Run;
		}
		...
		else if(strstr((char*)com1_rx_buffer,"MOTORY-S:"))
		{
			...
			MotorSetSpeed( Motor_y,  (pdBuffer[0]/(10.00)));
			return MOTORY_Speed;
		}
		...
		else if(strstr((char*)com1_rx_buffer,"MOTORY-RUN:"))
		{
			...
			MotorRun( Motor_y,   pdBuffer[0],pdBuffer[1]/(10.00), (pdBuffer[2]/(10.00)));
			return MOTORY_Run;
		}
		else  return 0;
	}
